...
@app.route('/diplomacy/delete', methods=['POST'])
def delete():
    if 'user' not in session:
        return redirect(url_for('login'))
    user = session['user']
...
@app.route('/diplomacy/logout')
def logout():
    session.pop('user', None)
    return redirect(url_for('home'))

@app.route('/diplomacy/menu')
def menu():
    archive_dir = './archive/'
...
@app.route('/diplomacy/archive/<filename>')
...
@app.route('/diplomacy/assets/<path:filename>')
